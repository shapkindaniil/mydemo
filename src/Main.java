...
public class Main {
    ...
    private static void globalWork(String userInput) throws Exception {
    ...
    public static String calculated(String num1, String num2, char op) throws Exception {
        if (num1.length()>10 || num2.length()>10) throw new Exception("Калькулятор принимает на вход строки длиной 10 включительно");
        if (Integer.parseInt(num1)<1 || Integer.parseInt(num2)>10) throw new Exception("Калькулятор приминает на вход числа от 1 до 10включительно");
